...
export default function BooksItemComponent({ book }: Props) {
  return (
    <div className="w-full group hover:shadow-lg min-h-[346px] bg-white p-4 rounded-lg h-fit">
      <div className="">
        <img className="h-40 rounded w-full object-cover object-center mb-6" src={book?.imgUrl ? `https://coursesnodejs.herokuapp.com/${book?.imgUrl}` : 'https://www.sicilywelcome.com/assets/images/placeholders/no-img-placeholder.png'} alt="content" />
