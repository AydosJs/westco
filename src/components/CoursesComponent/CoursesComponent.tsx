...
export default function CoursesComponent({ course }: Props) {
  return (
    <div className="w-full group hover:shadow-lg h-auto min-h-[346px] bg-white rounded-lg p-4">
      <div className="">
        <img className="h-40 rounded w-full object-cover object-center mb-4" src={'https://d1ymz67w5raq8g.cloudfront.net/Pictures/1024x536/P/web/n/z/b/onlinecourses_shutterstock_490891228_2000px_728945.jpg'} alt="content" />
