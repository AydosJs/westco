...
export default function CoursesComponent({ course }: Props) {
  return (
    <div className="w-full group hover:shadow-lg h-auto min-h-[346px] bg-white rounded-lg p-4">
      <div className="">
        <img className="h-40 rounded w-full object-cover object-center mb-4" src={course?.imgUrl ? `https://coursesnodejs.herokuapp.com/${course?.imgUrl}` : 'https://www.sicilywelcome.com/assets/images/placeholders/no-img-placeholder.png'} alt="content" />
        {/* <img className="h-40 rounded w-full object-cover object-center mb-4" src={course?.imgUrl && course?.imgUrl !== 'img/img-a463268af6f271bc3adac0871d505b4a.jpg' ? course?.imgUrl : 'https://d1ymz67w5raq8g.cloudfront.net/Pictures/1024x536/P/web/n/z/b/onlinecourses_shutterstock_490891228_2000px_728945.jpg'} alt="content" /> */}
        ...
        <p className="max-w-[400px] overflow-hidden text-ellipsis leading-relaxed text-base text-gray-600 line-clamp-3">
          {/* {course?.description} */}
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur maiores sint aspernatur amet corporis, laborum expedita fugit nisi fuga voluptatem ipsam consequatur repudiandae.
        </p>
      </div>
    </div>
  )
